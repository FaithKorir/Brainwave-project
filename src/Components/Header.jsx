    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        ...
        <nav
          ...
          } fixed top-[5rem] left-0 right-0 bottom-0 lg:static lg:flex lg:mx-auto bg-n-8 lg:bg-transparent`}
        >
          <div className="relative z-2 flex flex-col items-center justify-center lg:flex-row m-auto">
            {navigation.map((item) => (
              <a
                ...
                href={item.url}
                onClick={handleClick}
                className={`block relative font-sans  text-2xl  text-n-1 transition-colors hover:text-color-1  ${
                  item.onlyMobile ? "lg:hidden" : ""
                } px-6 py-6 md:py-8 lg:mx-0.25 lg:text-xs lg:font-semibold ${
