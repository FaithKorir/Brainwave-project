    ...
    >
      <div className="container relative" ref={parallaxRef}>
        <div className="relative z-1 max-w-[62rem] text-center mx-auto mb-[4rem] md:mb-20 lg:mb-[6rem]">
          ...
          <p className="body-1 mx-auto max-w-3xl mb-6 text-n-4 lg:mb-8">
        ...
        <div className="relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24">
          <div className="relative z-10 p-0.5 rounded-2xl bg-conic-gradient">
            <div className="relative rounded-[1rem] bg-n-8">
              ...
              <div className="aspect-[33/40] rounded-b-[0.9rem] md:aspect-[688/490] lg:aspect-[1024/490] overflow-hidden">
                <img src={robot} alt="AI" width={1024} height={490} />
          ...
          <div className="absolute -top-[54%] left-1/2 w-[254%] -translate-x-1/2 md:-top-[46%] md:w-[138%] lg:-top-[104]%">
            <img
              src={heroBackground}
